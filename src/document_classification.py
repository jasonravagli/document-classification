...
if __name__ == "__main__":
    ...
    parser.add_argument("--training.lr", dest="lr", type=float, help="Learning rate")
    parser.add_argument("--training.batch_size", dest="batch_size", type=int, help="Batch size used for training")
    args = parser.parse_args()

    config.add_command_line_args(args)
    config.config["training"].set_args(args)
